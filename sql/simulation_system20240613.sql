...
) ENGINE = InnoDB AUTO_INCREMENT = 319 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (2011, '作业计算提交', 2014, 2, 1, 'submit', '', '', 1, 0, 'F', '0', '0', 'task:home:submit', 'tree-table', 'admin', '2024-04-02 22:43:23', 'admin', '2024-06-12 22:41:39', '');
INSERT INTO `sys_menu` VALUES (2012, '作业计算查询', 2014, 2, 2, 'view', '', NULL, 1, 0, 'F', '0', '0', 'task:home:view', 'dict', 'admin', '2024-04-02 22:48:08', 'admin', '2024-06-12 22:42:14', '');
INSERT INTO `sys_menu` VALUES (2013, '仿真生命周期平台', 0, 2, 6, 'lifecycle', 'simulation/lifecycle/home/index', NULL, 0, 0, 'C', '0', '0', 'lifecycle:home:list', 'druid', 'admin', '2024-04-08 22:21:37', 'admin', '2024-06-12 22:05:53', '');
INSERT INTO `sys_menu` VALUES (2014, '计算调度平台', 0, 2, 7, 'task', 'simulation/task/home/index', NULL, 0, 0, 'C', '0', '0', 'task:home:list', '#', 'admin', '2024-04-08 22:22:25', 'admin', '2024-06-12 22:40:08', '');
INSERT INTO `sys_menu` VALUES (2015, '后处理平台', 0, 2, 8, 'post', 'simulation/post/home/index', NULL, 0, 0, 'C', '0', '0', 'post:home:list', '#', 'admin', '2024-04-08 22:22:59', 'admin', '2024-06-12 22:42:42', '');
INSERT INTO `sys_menu` VALUES (2016, '建模流程监控', 2013, 2, 1, 'model', '', NULL, 1, 0, 'F', '0', '0', 'lifecycle:home:flow', '#', 'admin', '2024-04-08 22:38:54', 'admin', '2024-06-12 22:06:52', '');
INSERT INTO `sys_menu` VALUES (2017, '精度研究', 2013, 2, 2, 'tool', '', NULL, 1, 0, 'F', '0', '0', 'lifecycle:home:precision', '#', 'admin', '2024-04-08 22:40:39', 'admin', '2024-06-12 22:07:48', '');
INSERT INTO `sys_menu` VALUES (2018, '后处理任务查询', 2015, 2, 1, 'task', '', NULL, 1, 0, 'F', '0', '0', 'post:home:view', '#', 'admin', '2024-04-08 22:41:42', 'admin', '2024-06-12 22:43:20', '');
INSERT INTO `sys_menu` VALUES (2019, '后处理自定义', 2015, 2, 2, 'define', '', NULL, 1, 0, 'F', '0', '0', 'post:home:define', '#', 'admin', '2024-04-08 22:42:27', 'admin', '2024-06-12 22:43:53', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统平台表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role` VALUES (100, '管理员', 'caeAdmin', 0, '1', 1, 1, '0', '0', 'admin', '2024-03-25 23:21:16', 'admin', '2024-04-10 23:52:10', NULL);
