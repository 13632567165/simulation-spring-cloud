...
) ENGINE = InnoDB AUTO_INCREMENT = 281 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (2011, '作业提交', 2014, 2, 1, 'submit', 'simulation/task/submit/index', 'submit', 1, 0, 'C', '0', '0', 'task:submit:list', 'tree-table', 'admin', '2024-04-02 22:43:23', 'admin', '2024-04-08 22:28:05', '');
INSERT INTO `sys_menu` VALUES (2012, '作业查询', 2014, 2, 2, 'view', 'simulation/task/view/index', NULL, 1, 0, 'C', '0', '0', 'task:view:list', 'dict', 'admin', '2024-04-02 22:48:08', 'admin', '2024-04-08 22:36:49', '');
INSERT INTO `sys_menu` VALUES (2013, '仿真前处理', 0, 2, 6, 'pretreatment', NULL, NULL, 1, 0, 'M', '0', '0', '', '#', 'admin', '2024-04-08 22:21:37', 'admin', '2024-04-08 22:25:25', '');
INSERT INTO `sys_menu` VALUES (2014, '仿真计算', 0, 2, 7, 'task', NULL, NULL, 1, 0, 'M', '0', '0', '', '#', 'admin', '2024-04-08 22:22:25', 'admin', '2024-04-08 22:25:35', '');
INSERT INTO `sys_menu` VALUES (2015, '仿真后处理', 0, 2, 8, 'post', NULL, NULL, 1, 0, 'M', '0', '0', '', '#', 'admin', '2024-04-08 22:22:59', 'admin', '2024-04-08 22:25:56', '');
INSERT INTO `sys_menu` VALUES (2016, '前处理建模', 2013, 2, 1, 'model', 'simulation/pretreatment/model/index', NULL, 1, 0, 'C', '0', '0', 'pretreatment:model:list', '#', 'admin', '2024-04-08 22:38:54', 'admin', '2024-04-08 22:51:25', '');
INSERT INTO `sys_menu` VALUES (2017, '前处理工具', 2013, 2, 2, 'tool', 'simulation/pretreatment/tool/index', NULL, 1, 0, 'C', '0', '0', 'pretreatment:tool:list', '#', 'admin', '2024-04-08 22:40:39', 'admin', '2024-04-08 22:51:29', '');
INSERT INTO `sys_menu` VALUES (2018, '后处理作业', 2015, 2, 1, 'task', 'simulation/post/task/index', NULL, 1, 0, 'C', '0', '0', 'post:task:list', '#', 'admin', '2024-04-08 22:41:42', 'admin', '2024-04-08 22:51:10', '');
INSERT INTO `sys_menu` VALUES (2019, '后处理自定义', 2015, 2, 2, 'define', 'simulation/post/define/index', NULL, 1, 0, 'C', '0', '0', 'post:define:list', '#', 'admin', '2024-04-08 22:42:27', 'admin', '2024-04-08 22:51:14', '');
...
INSERT INTO `sys_role` VALUES (100, '管理员', 'caeAdmin', 0, '1', 1, 1, '0', '0', 'admin', '2024-03-25 23:21:16', 'admin', '2024-04-08 22:44:53', NULL);
